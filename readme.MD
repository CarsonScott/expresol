...
- define sets of characters that are valid in the formation of symbols assigned to instances of each type
...
- store pairs of classes that are valid when observed consecutively in a statement
